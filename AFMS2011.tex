...
By now, it is clear that we aim to provide a semantic way to express the functionality of a service -- as well as its communication -- in a concise way that appeals to humans and can be processed automatically. The word ``semantic'' obviously hints at the Semantic Web~\cite{SemanticWeb} and its core language RDF~\cite{RDF}.
