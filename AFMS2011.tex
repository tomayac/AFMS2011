...
\subsection{Do we need this shit}

\todo{Thomas to write this stuff}
...
\subsection{Automated discovery, composition, and execution}
This use case presents an overview of the general architecture of RESTdesc for multimedia algorithms.
\\*\todo{See Google Docs.}

\subsection{Linking to external services}
\todo{See Google Docs.}


\subsection{Adapting to change and errors}
\todo{See Google Docs.}
