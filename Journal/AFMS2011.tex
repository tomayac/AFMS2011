...
\title{Capturing the functionality of Web services\\ with functional descriptions}
...
Additional RESTdesc information can also be found on the official website \url{http://restdesc.org/}.
...
\begin{multline}\label{eq:NaiveRdf}
    \fontsize{9}{11}\texttt{:request :uri ("/photos/" :id);} \\[-.5em]
    \fontsize{9}{11}\texttt{:response [ :represents [:photoId :id] ].}\makebox[1.22cm]{}
\end{multline}
